...
matriz_colores[0][0] =  128;
matriz_colores[0][1] =  128;
matriz_colores[0][2] =  0;

matriz_colores[1][0] =  255;
matriz_colores[1][1] =  255;
matriz_colores[1][2] =  0;

matriz_colores[2][0] =  0;
matriz_colores[2][1] =  255;
matriz_colores[2][2] =  128;

matriz_colores[3][0] =  102;
matriz_colores[3][1] =  128;
matriz_colores[3][2] =  128;

matriz_colores[4][0] =  0;
matriz_colores[4][1] =  255;
matriz_colores[4][2] =  178;

matriz_colores[5][0] =  0;
matriz_colores[5][1] =  128;
matriz_colores[5][2] =  128;
...
glPixelStorei(GL_PACK_ALIGNMENT, 1);
  ...
  glReadPixels(x, y, 2, 2, GL_RGBA, GL_UNSIGNED_BYTE, pixels);
...
/*
    if (pixel[0] == 128) nombre_seleccion = 11;
    else if (pixel[0] == 255) nombre_seleccion = 12;
    else if (pixel[0] == 102 ) nombre_seleccion = 14;
    else if (pixel[0] == 0)  {
        if (pixel[1] == 128) nombre_seleccion = 16;
        else if (pixel  [1] == 255)  {
            if (pixel[2] == 128) nombre_seleccion = 13;
            else if (pixel[2] == 178) nombre_seleccion = 15;
        }
    } 
*/

    //nombre_seleccion = pixel[0]+pixel[1]+pixel[2];
    // Dibujo
    //draw_objects_5();
